...
def create_cron_jobs(mailing):
    """
    Create a cron job for a mailing.

    Args:
        mailing (Mailing): The mailing for which to create a cron job.
...
def remove_cron_jobs(mailing):
    """
    Remove cron jobs associated with a mailing.

    Args:
        mailing (Mailing): The mailing for which to remove cron jobs.
