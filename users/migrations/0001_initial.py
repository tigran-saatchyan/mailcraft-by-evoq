...
def load_initial_countries(apps, schema_editor):
    ...
    filename: Path = Path(static_url, 'users/data/countries.json')
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.CharField(
                    blank=True, max_length=255, null=True, verbose_name='код'
                    )),
            ],
            options={
                'verbose_name': 'страна',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ImageField(
                    blank=True, null=True, upload_to=users.models.save_picture
                    )),
                ...
                ('country', models.ForeignKey(
                    ...
                    to='users.country', verbose_name='страна'
                    )),
