    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('telephone', models.CharField(blank=True, max_length=50, null=True, verbose_name='телефон')),
                ('avatar', models.ImageField(blank=True, null=True, upload_to=service.utils.save_picture)),
                ...
                ('country', models.ForeignKey(blank=True, max_length=255, null=True, on_delete=django.db.models.deletion.CASCADE, to='users.country', verbose_name='страна')),
